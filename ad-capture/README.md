...
- ระบบจะแคปภาพภายใน 5 วินาทีหลังเปิดลิงก์เสมอ (โฆษณาวิดีโอมักเล่นทันทีและจบเร็ว
  รอนานไปจะพลาดโฆษณา) — ปรับได้ที่ค่าคงที่ `CAPTURE_DEADLINE_MS` ใน `lib/adcapture.js`
